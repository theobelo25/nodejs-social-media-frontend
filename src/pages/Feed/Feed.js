...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch(process.env.REACT_APP_DB_HOST, {
      ...
      .then((resData) => {
        if (resData.errors) throw new Error("Could not fetch status.");
  ...
  loadPosts = (direction) => {
    ...
    fetch(process.env.REACT_APP_DB_HOST, {
      ...
      .then((resData) => {
        console.log(resData);
        if (resData.errors) throw new Error("Could not fetch posts.");
  ...
  statusUpdateHandler = (event) => {
    ...
    fetch(process.env.REACT_APP_DB_HOST, {
      ...
      .then((resData) => {
        if (resData.errors) throw new Error("Could not update status.");
        console.log(resData);
      })
      .catch(this.catchError);
  };
  ...
  finishEditHandler = (postData) => {
    ...
    fetch(process.env.REACT_APP_DB_HOST, {
      ...
      .then((fileResData) => {
        ...
        return fetch(process.env.REACT_APP_DB_HOST, {
          method: "POST",
          headers: {
            Authorization: `Bearer ${this.props.token}`,
            "Content-Type": "application/json",
